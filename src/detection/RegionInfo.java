...
public class RegionInfo {
   ...
   public static String labels(int n) {
	   String labels = "";
	   labels = labels + "marker_" + n + ",";
	   labels = labels + "isBubble_" + n + ",";
	   labels = labels + "minX_" + n + ",";
	   labels = labels + "minY_" + n + ",";
	   labels = labels + "maxX_" + n + ",";
	   labels = labels + "maxY_" + n + ",";
	   labels = labels + "pixCount_" + n + ",";
	   labels = labels + "xRange_" + n + ",";
	   labels = labels + "yRange_" + n + ",";
	   labels = labels + "isAreaLessThanMax_" + n + ",";
	   labels = labels + "isAreaMoreThanMin_" + n + ",";
	   labels = labels + "isXLessThanMax_" + n + ",";
	   labels = labels + "isYLessThanMax_" + n + ",";
	   labels = labels + "isRegionEnclosed_" + n + ",";
	   labels = labels + "isPixCountMoreThanMin_" + n + ",";
	   labels = labels + "isDistBtwCentersLessThanMax_" + n + ",";
	   labels = labels + "distBtwCenters_" + n + ",";
	   labels = labels + "blkPixPercent_" + n + ",";
	   labels = labels + "sumPix_" + n + ",";
	   labels = labels + "sdHoriz_" + n + ",";
	   labels = labels + "sdVert_" + n + ",";
	   labels = labels + "sdPix_" + n + ",";
	   labels = labels + "enclosed_" + n + ",";
	   labels = labels + "percentEnclosed_" + n + ",";
	   labels = labels + "percentArea_" + n + ",";
       //labels = labels + this.histR.toCsvString() + ", ";
	   labels = labels + "histH_1_" + n + ",";
	   labels = labels + "histH_2_" + n + ",";
	   labels = labels + "histH_3_" + n + ",";
	   labels = labels + "histH_4_" + n + ",";
	   labels = labels + "histH_5_" + n + ",";
	   labels = labels + "histH_6_" + n + ",";
	   labels = labels + "histH_7_" + n + ",";
	   labels = labels + "histH_8_" + n + ",";
	   labels = labels + "histH_9_" + n + ",";
	   labels = labels + "histH_10_" + n + ",";
	   labels = labels + "histV_1_" + n + ",";
	   labels = labels + "histV_2_" + n + ",";
	   labels = labels + "histV_3_" + n + ",";
	   labels = labels + "histV_4_" + n + ",";
	   labels = labels + "histV_5_" + n + ",";
	   labels = labels + "histV_6_" + n + ",";
	   labels = labels + "histV_7_" + n + ",";
	   labels = labels + "histV_8_" + n + ",";
	   labels = labels + "histV_9_" + n + ",";
	   labels = labels + "histV_10_" + n + ",";
	   labels = labels + "histR_1_" + n + ",";
	   labels = labels + "histR_2_" + n + ",";
	   labels = labels + "histR_3_" + n + ",";
	   labels = labels + "histR_4_" + n + ",";
	   labels = labels + "histR_5_" + n + ",";
	   labels = labels + "histR_6_" + n + ",";
	   labels = labels + "histR_7_" + n + ",";
	   labels = labels + "histR_8_" + n + ",";
	   labels = labels + "histR_9_" + n + ",";
	   labels = labels + "histR_10_" + n + ",";
	   labels = labels + "histR_11_" + n + ",";
	   labels = labels + "histR_12_" + n + ",";
	   labels = labels + "histR_13_" + n + ",";
	   labels = labels + "histR_14_" + n + ",";
	   labels = labels + "histR_15_" + n + ",";
	   labels = labels + "histR_16_" + n + ",";
	   labels = labels + "histR_17_" + n + ",";
	   labels = labels + "histR_18_" + n + ",";
	   labels = labels + "histR_19_" + n + ",";
	   labels = labels + "histR_20_" + n + ",";
	   labels = labels + "histR_21_" + n + ",";
	   labels = labels + "histR_22_" + n + ",";
	   labels = labels + "histR_23_" + n + ",";
	   labels = labels + "histR_24_" + n;

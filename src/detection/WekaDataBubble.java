...
public class WekaDataBubble extends WekaData implements WekaFormat {

	private final int numFields = 67;
	
	public WekaDataBubble(int size) {
		super();
	...
	public FastVector createVector() {
		...
		FastVector fvWekaAttributes = new FastVector(super.getNumAttributes());
	...
	public Instances createInstances(FastVector fvWekaAttributes, List<String> strArray) {
		...
		for (String str : strArray) {
			...
			tokens = str.split(",");
			Instance vector = new Instance(super.getNumAttributes());
